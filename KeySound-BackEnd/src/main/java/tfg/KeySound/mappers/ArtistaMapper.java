...
public interface ArtistaMapper {
    ...
    ResponseArtistaDTO toDto(Usuario artista, List<ResponseCancionArtistaDTO> canciones, List<ResponseAlbumArtistaDTO> albums, int cancionesEnFavoritos, String urlAvatar);
}
