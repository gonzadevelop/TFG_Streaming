...
import { IPistaHome } from '../model/home/IPistaHome';
...
export class CancionService {
   ...
   */
  getCancionesMasReproducidas(): Observable<IPistaHome[]> {
    return this.http.get<IPistaHome[]>(`${this.baseURL}/canciones/mis-canciones-mas-reproducidas`);
  }
}
